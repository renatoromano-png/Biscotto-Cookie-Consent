...
function consentkit_cookie_row( $i, $row, $opt, $cats ) {
	...
	?>
	<tr>
		<td><input type="text" name="<?php echo esc_attr( $opt ); ?>[cookies][<?php echo esc_attr( $i ); ?>][name]" value="<?php echo esc_attr( $name ); ?>" placeholder="<?php esc_attr_e( 'es. _ga', 'biscotto-cookie-consent' ); ?>" /></td>
		<td><input type="text" name="<?php echo esc_attr( $opt ); ?>[cookies][<?php echo esc_attr( $i ); ?>][service]" value="<?php echo esc_attr( $service ); ?>" placeholder="<?php esc_attr_e( 'es. Google Analytics', 'biscotto-cookie-consent' ); ?>" /></td>
		<td><input type="text" name="<?php echo esc_attr( $opt ); ?>[cookies][<?php echo esc_attr( $i ); ?>][duration]" value="<?php echo esc_attr( $duration ); ?>" placeholder="<?php esc_attr_e( 'es. 2 anni', 'biscotto-cookie-consent' ); ?>" /></td>
		<td>
		...
		<td><button type="button" class="button-link biscotto-remove-row" aria-label="<?php esc_attr_e( 'Rimuovi', 'biscotto-cookie-consent' ); ?>">&times;</button></td>
	</tr>
	<?php
}
?>
<p class="description">
	<?php esc_html_e( 'Elenca qui i cookie/servizi che il sito usa davvero: popola il registro dal tab Scansione oppure aggiungili a mano. Per le terze parti basta servizio, categoria e link alla loro policy: non serve ogni singolo cookie (Garante).', 'biscotto-cookie-consent' ); ?>
</p>
...
<table class="widefat striped consentkit-cookies">
	<thead>
		<tr>
			...
			<th><?php esc_html_e( 'URL policy (terze parti)', 'biscotto-cookie-consent' ); ?></th>
			<th></th>
		</tr>
	</thead>
...
<p>
	<button type="button" class="button" id="biscotto-add-cookie"><?php esc_html_e( '+ Aggiungi cookie', 'biscotto-cookie-consent' ); ?></button>
	<button type="button" class="button" id="biscotto-clear-cookies"><?php esc_html_e( 'Svuota registro', 'biscotto-cookie-consent' ); ?></button>
	<span class="description"><?php esc_html_e( 'Dopo aver svuotato, ricordati di salvare.', 'biscotto-cookie-consent' ); ?></span>
</p>
